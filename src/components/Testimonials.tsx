          ...
          {testimonials.map((t, index) => (
            ...
            >
              <div className="h-full bg-white/5 border border-white/10 hover:border-blue-500/30 hover:bg-white/8 rounded-2xl p-8 flex flex-col transition-all duration-300">
                ...
                <div className="text-blue-500/30 text-6xl font-serif leading-none mb-2 select-none">
                  &ldquo;
                </div>
                <Stars />
                <blockquote className="text-white/70 leading-relaxed flex-1 mb-8 text-[0.95rem]">
                  {t.quote}
                </blockquote>
