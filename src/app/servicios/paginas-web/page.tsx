...
import { ArrowRight, ArrowLeft, CheckCircle, Globe, Zap, Shield, Smartphone } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-white/55 leading-relaxed mb-10 max-w-2xl">
                ...
                que se vea bien, cargue rápido y convierta visitas en clientes reales.
              </p>
